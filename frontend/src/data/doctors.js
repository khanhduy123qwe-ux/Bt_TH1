// doctors.js — Dữ liệu danh sách bác sĩ
const doctors = [
  ...
  { emoji: '👨‍⚕️', name: 'BS. Võ Thanh Bình',     specialty: 'Nội tổng quát', rating: '4.7', reviews: 89 },
  { emoji: '👩‍⚕️', name: 'BS. Nguyễn Thị Mai',    specialty: 'Sản phụ khoa',  rating: '4.8', reviews: 112 },
]

// Export default VÀ named để tránh lỗi import {doctors}
export { doctors };
